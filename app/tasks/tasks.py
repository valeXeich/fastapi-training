...
from app.tasks.email_templates import create_booking_confiramtion_template
...
@celery.task
def send_booking_confiramtion_email(booking: dict, email_to: EmailStr):
    msg_content = create_booking_confiramtion_template(booking, email_to)
